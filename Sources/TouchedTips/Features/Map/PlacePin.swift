...
/// is a count. The ring is solid when someone was witnessed here and faint when only inferred.
struct PlacePin: View {
    ...
    var body: some View {
        ...
        .overlay {
            Circle().strokeBorder(.white.opacity(place.witnessed ? 1 : 0.45), lineWidth: 2)
        }
