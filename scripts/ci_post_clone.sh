...
# TouchedTips.xcodeproj is gitignored, so generate it here, then stamp the
...
sed -i '' "s/CURRENT_PROJECT_VERSION = [0-9]*;/CURRENT_PROJECT_VERSION = ${CI_BUILD_NUMBER};/g" TouchedTips.xcodeproj/project.pbxproj
